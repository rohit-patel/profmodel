"""
Django settings for proft1 project.
...
SECRET_KEY = '3mmw(#jg(o2kk)&7u5y4-dq2%c^o5+c+j05anqjdys%0p01y_5'
...
WSGI_APPLICATION = 'proft1.wsgi.application'
...
#Settings for connection to google database
#DATABASES = {
#    'default': {
...
LOGIN_REDIRECT_URL = '/prof/user/home'
LOGIN_URL = '/login/'
